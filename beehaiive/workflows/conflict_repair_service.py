...
from ..routing import AttemptOutcome
...
from .conflict_repair_agent import ConflictRepairAgent
from .conflict_repair_helpers import execution_evidence, same_repair_identity
...
class ConflictRepairService:
    ...
    def _run_repair(
        ...
        try:
            ...
            evidence["agent"] = execution_evidence(execution)
            ...
            if not same_repair_identity(before, current):
                raise ProviderError(
